...
fileprivate let userAgent = "SolarEdge API for Swift"
...
public enum SolarEdgeAPI {
    ...
    static private let baseURL = "https://monitoringapi.solaredge.com"
...
public extension SolarEdgeAPI {
    ...
    static func energy(for siteId: Int, using energyParameter: EnergyRequestParameter, apiKey: String) async throws -> Energy {
        var components = URLComponents(string: baseURL)!
    ...
    static func totalEnergy(for siteId: Int, startDate: Date, endDate: Date, apiKey: String) async throws -> Energy.TimePeriodDataPoint {
        var components = URLComponents(string: baseURL)!
        ...
        struct TimeFrameEnergyResponse: Codable {
            let timeFrameEnergy: Energy.TimePeriodDataPoint
        }
    ...
    static func power(for siteId: Int, startTime: Date, endTime: Date, apiKey: String) async throws -> Power {
        var components = URLComponents(string: baseURL)!
    ...
    static func overview(for siteId: Int, apiKey: String) async throws -> Overview {
        var components = URLComponents(string: baseURL)!
    ...
    static func detailedPower(for siteId: Int, from startTime: Date, until endTime: Date, meterTypes: Set<MeterData.MeterType>? = nil, apiKey: String) async throws -> PowerDetail {
        var components = URLComponents(string: baseURL)!
    ...
    static func detailedEnergy(for siteId: Int, from startTime: Date, until endTime: Date, timeUnit: TimeUnit = .day, meterTypes: Set<MeterData.MeterType>? = nil, apiKey: String) async throws -> EnergyDetail {
        var components = URLComponents(string: baseURL)!
        ...
        struct EnergyDetailResponse: Codable {
            let energyDetails: EnergyDetail
        }
    ...
    static func powerFlow(for siteId: Int, apiKey: String) async throws -> PowerFlow {
        var components = URLComponents(string: baseURL)!
    ...
    static func environmentalBenefits(for siteId: Int, systemUnit: SystemUnit = .metric, apiKey: String) async throws -> EnvironmentalBenefits {
        var components = URLComponents(string: baseURL)!
        ...
        struct EnvironmentalBenefitsResponse: Codable {
            let envBenefits: EnvironmentalBenefits
        }
        
        do {
            return try JSONDecoder().decode(EnvironmentalBenefitsResponse.self, from: data).envBenefits
        } catch {
            throw Errors.decoding(error.localizedDescription)
        }
    }
    ...
    static func components(for siteId: Int, apiKey: String) async throws -> [Component] {
        var components = URLComponents(string: baseURL)!
    ...
    static func inventory(for siteId: Int, apiKey: String) async throws -> Inventory {
        var components = URLComponents(string: baseURL)!
    ...
    static func metersLifetimeData(for siteId: Int, startTime: Date, endTime: Date, timeUnit: TimeUnit = .day, meterTypes: Set<MeterData.MeterType>? = nil, apiKey: String) async throws -> MetersData {
        var components = URLComponents(string: baseURL)!
        ...
        struct MeterDataResponse: Codable {
            let meterEnergyDetails: MetersData
        }
