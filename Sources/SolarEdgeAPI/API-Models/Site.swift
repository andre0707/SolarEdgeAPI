...
public struct Site: Codable {
    ...
    public init(from decoder: Decoder) throws {
        ...
        self.lastUpdateTime = DateFormatter.apiDate.date(from: _lastUpdateTime) ?? Date.distantPast
        
        self.currency = try container.decodeIfPresent(String.self, forKey: .currency)
                
        let _installationDate = try container.decode(String.self, forKey: .installationDate)
        self.installationDate = DateFormatter.apiDateTime.date(from: _installationDate) ?? Date.distantPast
